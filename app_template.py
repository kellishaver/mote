...
#
# Guidelines:
# - Call touch.get_touch() every loop iteration, even if you ignore the
#   result. It drives the two-finger exit gesture and the idle timer;
#   an app that stops polling cannot be exited.
...
# - Long blocking calls freeze the exit gesture. If you must block for more
#   than ~1s, poll touch during the wait (see app_iping's ping timeout).
